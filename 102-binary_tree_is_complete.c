 ...
 * @node: Specifies the binary tree node for the new node
...
/**
 * push - Starts to push a node to the back of a levelorder_queue
...
/**
 * binary_tree_is_complete - Starts to check if a binary tree is complete
 * @tree: Specifies a pointer to the root node of the tree
 * Return: 0 if the tree is NULL or not complete,or 1 if otherwise
 */
int binary_tree_is_complete(const binary_tree_t *tree)
{
